...
async function sendNewReportEmail({ report, excelPath, photoPath, minimal = false }) {
 ...
 <tr>
  ...
  <table dir="rtl" role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; max-width:560px; background:#ffffff; border:1px solid #d8dce1;">
...
${embedPhoto ? `
    <tr>
      <td style="padding:20px 22px 0; text-align:right;">
        ...
        <img src="cid:hazardphoto" style="width:100%; max-width:300px; height:auto; display:block; border:1px solid #d8dce1;" alt="תמונת המפגע" />
      </td>
    </tr>` : ''}
