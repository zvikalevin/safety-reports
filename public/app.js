(function () {
  const TRANSLATIONS = {
    he: {
      ...
      locations: ['קו ייצור A', 'קו ייצור B', 'מחסן', 'מסדרון ראשי', 'חדר בקרה', 'חצר חיצונית', 'מעבדה', 'חדר עגינה / טעינה'],
    },
    ru: {
      dir: 'ltr',
      ...
      locations: ['Линия A', 'Линия B', 'Склад', 'Главный коридор', 'Диспетчерская', 'Внешний двор', 'Лаборатория', 'Погрузочная зона'],
    },
  };
